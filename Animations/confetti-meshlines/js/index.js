...
Allows the use of WebGL constructs without having to write WebGL code
...
Webgl = function () {
  ...
  {
    key: 'remove', value: function remove(mesh) {
...
var meshlines = document.getElementById("meshlines");
meshlines.appendChild(webgl.dom);
...
function WindLine() {
  ...
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      nbrOfPoints = _ref$nbrOfPoints === undefined ? getRandomFloat(3, 5) : _ref$nbrOfPoints,
      _ref$length = _ref.length,length = _ref$length === undefined ? getRandomFloat(5, 8) : _ref$length,_ref$disruptedOrienta = _ref.disruptedOrientation,
      disruptedOrientation = _ref$disruptedOrienta === undefined ? getRandomFloat(-0.2, 0.2) : _ref$disruptedOrienta,
      _ref$speed = _ref.speed,speed = _ref$speed === undefined ? 0.003 : _ref$speed,
      _ref$color = _ref.color,
      color = _ref$color === undefined ? new Color('#000000') : _ref$color;_classCallCheck(this, WindLine);
  ...
  var Wind = function (_Object3D) {

    _inherits(Wind, _Object3D);

  function Wind() {
    _classCallCheck(this, Wind);var _this2 = _possibleConstructorReturn(this, (Wind.__proto__ || Object.getPrototypeOf(Wind)).call(this));
...
var AnimatedText = function (_Object3D2) {

  _inherits(AnimatedText, _Object3D2);

  function AnimatedText(text, font) {
    var _ref2 = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {},
        _ref2$size = _ref2.size,size = _ref2$size === undefined ? 0.3 : _ref2$size,
        _ref2$letterSpacing = _ref2.letterSpacing,
        letterSpacing = _ref2$letterSpacing === undefined ? 0.03 : _ref2$letterSpacing,
        _ref2$color = _ref2.color,
        color = _ref2$color === undefined ? '#000000' : _ref2$color;

        _classCallCheck(this, AnimatedText);
        var _this3 = _possibleConstructorReturn(this, (AnimatedText.__proto__ || Object.getPrototypeOf(AnimatedText)).call(this));
...
setTimeout(function () {
  ...
  var text = new AnimatedText('FESTIVITY TEXT', fontAsset);
